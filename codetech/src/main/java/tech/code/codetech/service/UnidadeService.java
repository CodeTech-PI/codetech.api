...
public class UnidadeService implements UnidadeInterface {
    ...
    public int quantidadeDeUnidades() {
        return unidadeRepository.quantidadeDeUnidades();
    }

    public List<Unidade> findAllByOrderByIdAsc() {
        return unidadeRepository.findAllByOrderByIdAsc();
    }

    public List<Unidade> findAllByStatus(StatusUnidade statusUnidade) {
        return unidadeRepository.findAllByStatusUnidade(statusUnidade);
    }
}