...
public class AutenticacaoProvier implements AuthenticationProvider {

    private final AutenticacaoService usuarioAutorizacaoService;
    private final PasswordEncoder passwordEncoder;

    public AutenticacaoProvier(AutenticacaoService usuarioAutorizacaoService, PasswordEncoder passwordEncoder) {
